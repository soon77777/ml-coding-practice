...
scatter = plt.scatter(x='Age', y  'Fare', data = titanic, c= titanic['Survived'],smap='Set2',alpha=0.7)
...
plt.pie(survived_counts, labels=['Not Survived'], colors=['orange','gold'],
...
axes[0].tick_parms(axis='y', labelcolor='indigo')
...
axes[1].tick-params(axis='y', labelcolor='deeppink')
...
# 첫 번째 그래프 설정 (선 그래프)
ax.plot(x, y1, '-s', color='indigo', markersize=7, linewidth=5, alpha=0.7, label='Not Survived')
...
plt.suptitle('Survival Analysis by Number of Parents/Chil')